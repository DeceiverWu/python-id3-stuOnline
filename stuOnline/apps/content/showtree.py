...
def createPlot(inTree):
    fig = plt.figure(1, facecolor='white', figsize=(13, 7))
    fig.clf()
    ...
    plt.savefig(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 'static/images/decisionTree.jpg'))
    # plt.show()


# 定义一个预先创建树的函数（可用决策树代替）
# def retrieveTree(i):
